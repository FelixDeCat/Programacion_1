...
public class EnemyShooter : Entity, IRemovable<EnemyShooter>
{

    protected EnemyShooterPreset preset;
    public EnemyShooterPreset Preset { set { preset = value; } }
    bool isDeath;
    Action<EnemyShooter> del_to_remove;
    ...
    public override void Awake()
    {
        ...
        shoot = new Shoot<Bullet>(Bullet.Activar, Bullet.Desactivar, Bullet.SetPoolObj, pointToFire, 5f, bulletModel, bulletDamage);
    ...
    public void ConfigureToRemove(Action<EnemyShooter> deltoremove)
    {
